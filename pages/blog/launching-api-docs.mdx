...
<Blog title={"Launching API documentation you can subscribe to"} date={"2023-03-06"} author="aidan" image="/assets/subscribe.png"/>
...
APIs are fast-becoming the most important dependencies between teams. There are good tools for versioning our libraries (package managers) and code (git), but versioning APIs requires new approaches. APIs are different than other kinds of software because changes affect your consumers the moment you release them (they can’t pin themselves to a the stable version and integrate at their own pace).
